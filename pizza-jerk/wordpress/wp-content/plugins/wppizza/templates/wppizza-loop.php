 ...
 ********************************************/
	...
	/**price classes - allow filtering*****/
	$priceClass=apply_filters('wppizza_filter_price_class', $priceClass, $postId);/*enable filtering*/
	/***********************************************************
	*
...
?>
		<div id="<?php echo $post_type ?>-article-tiers-<?php echo $postId ?>" class="<?php echo $post_type ?>-article-tiers <?php echo $post_type ?>-article-prices-<?php echo $meta['sizes']; ?>">
	   	...
	   	?>
	   		<span id='<?php echo $post_type."-".$postId."-".$meta['sizes']."-".$k ?>' class='<?php echo $post_type ?>-article-price <?php echo $post_type ?>-article-price-<?php echo $meta['sizes']; ?>-<?php echo $k; ?> <?php echo $priceClass ?>' <?php echo $priceTitle ?>>
